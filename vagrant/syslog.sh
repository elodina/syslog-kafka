...
source /vagrant/vagrant/params.sh
...
#Build syslog binary
cd $GOPATH/src/github.com/elodina/syslog-kafka && $GOPATH/bin/godep restore && go build
...
$GOPATH/src/github.com/elodina/syslog-kafka/syslog-kafka $SYSLOG_ARGS --broker.list $HOST_IP_ADDR:9092 &
